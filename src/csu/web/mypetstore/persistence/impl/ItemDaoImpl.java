...
public class ItemDaoImpl implements ItemDao {
    private static final String getInventoryQuantityString = "SELECT QTY AS value QTY = QTY - ? WHERE ITEMID =?";
    private static final String updateInventoryQuantityString = "SELECT QTY AS value FROM INVENTORY WHERE ITEMID =?";
    private static final String getItemListByProductString = "SELECT I.ITEMID,LISTPRICE,UNITCOST,SUPPLIER AS supplierId,I.PRODUCTID,NAME,DESCN,CATEGORY,STATUS,ATTR1 AS attribute1,ATTR2 AS attribute2,ATTR3 AS attribute3,ATTR4 AS attribute4, ATTR5 AS attribute5 FROM ITEM I, PRODUCT P WHERE P.PRODUCTID = I.PRODUCTID AND I.PRODUCTID = ?";
